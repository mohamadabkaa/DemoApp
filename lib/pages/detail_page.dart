import 'package:demo_app/Widgets/app_buttons.dart';
             ...
             width: MediaQuery.of(context).size.width,
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height:10),
                  AppLargeText(text: "You must go for a travel. Travelling helps get rid of pressure.Go to the mountains to see the nature",size: 17,color:AppColors.mainTextColor),
                      ],
                    ),
                   )),
          Positioned(
